...
[![npm version](https://badge.fury.io/js/type-writer.svg)](https://www.npmjs.com/package/type-writer)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install type-writer
```
...
// Basic usage
const result = writer('your input here');
console.log(result);
```
...
```javascript
const { writer, batch } = require('type-writer');

// Single item
const result = writer('hello');
